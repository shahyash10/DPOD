...
def create_GT_masks(root_dir, intrinsic_matrix):
    """
    ...
    for i in range(len(training_images_idx)):
        ...
        ID_mask_file = root_dir + label + "/ground_truth/IDmasks/color" + str(idx) + ".png"
        U_mask_file = root_dir + label + "/ground_truth/Umasks/color" + str(idx) + ".png"
        V_mask_file = root_dir + label + "/ground_truth/Vmasks/color" + str(idx) + ".png"
